                    ...
                    <asp:View ID="View1" runat="server">
                        <table class="auto-style1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList5" runat="server" AutoPostBack="True" Height="31px" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged" Width="162px">
                                    </asp:DropDownList>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList7" runat="server" AutoPostBack="True" Height="16px" OnSelectedIndexChanged="DropDownList7_SelectedIndexChanged" Width="162px">
                                    </asp:DropDownList>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList10" runat="server" AutoPostBack="True" Height="16px" Width="163px">
                                    </asp:DropDownList>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
