                                ...
                                <td class="auto-style73">
                                    <table class="auto-style61">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownList20" runat="server" AutoPostBack="True" Height="29px" OnSelectedIndexChanged="DropDownList20_SelectedIndexChanged" Width="177px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownList18" runat="server" AutoPostBack="True" Height="29px" OnSelectedIndexChanged="DropDownList18_SelectedIndexChanged" Width="176px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownList19" runat="server" Height="16px" Width="174px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
