                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="View2" runat="server">
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td class="auto-style81" style="color: #000080">View Questions</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                    ...
                                    <asp:Panel ID="Panel3" runat="server" style="margin-left: 0px" Width="437px">
                                        <table class="auto-style1">
                                            ...
                                            <tr>
                                                <td class="auto-style84">&nbsp;</td>
                                                <td>
                                                    <asp:Button ID="Button10" runat="server" Height="30px" OnClick="Button10_Click" Text="Update" Width="109px" />
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="Button12" runat="server" Height="30px" OnClick="Button12_Click" Text="Delete" Width="99px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style84">&nbsp;</td>
                    ...
                    <asp:View ID="View3" runat="server">
                        <table class="auto-style1">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <table class="auto-style1">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBox31" runat="server" Height="82px" TextMode="MultiLine" Width="284px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style90">
                            ...
                            <tr>
                                <td class="auto-style85" style="color: #000080">View Marks</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList11" runat="server" Height="16px" Width="264px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList12" runat="server" Height="23px" Width="264px">
                                    </asp:DropDownList>
                                    &nbsp;
                                    ...
                                    <asp:Panel ID="Panel4" runat="server">
                                        <table class="auto-style1">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBox36" runat="server" Height="75px" TextMode="MultiLine" Width="299px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style89">
                                            ...
                                            <tr>
                                                <td class="auto-style89">&nbsp;</td>
                                                <td>
                                                    <asp:Button ID="Button13" runat="server" Height="30px" OnClick="Button13_Click" Text="Update" Width="86px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style89">&nbsp;</td>
