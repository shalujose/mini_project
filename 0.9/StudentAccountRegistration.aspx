...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style1" style="font-weight: bold">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox4" runat="server" Width="217px" MaxLength="10"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList5" runat="server" Height="19px" Width="224px" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged" AutoPostBack="True">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
