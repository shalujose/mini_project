...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Width="542px">
                                        <table class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style60">
                                                    <asp:DropDownList ID="DropDownList13" runat="server" OnSelectedIndexChanged="DropDownList13_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style21">&nbsp;</td>
            <td style="font-weight: bold; color: #000080;" class="auto-style5">Manage Users</td>
            <td class="auto-style22" style="font-weight: bold">&nbsp;</td>
            <td class="auto-style23" style="font-weight: bold">&nbsp;</td>
            <td class="auto-style24" style="font-weight: bold">&nbsp;</td>
            <td class="auto-style22" style="font-weight: bold">&nbsp;</td>
