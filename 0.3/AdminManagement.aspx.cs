...
public partial class AdminManagement : System.Web.UI.Page
{
    ...
    private void RequestAccount()
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=G:\12\App_Data\Database.mdf;Integrated Security=True");
        con.Open();
        string str = "select adno,name,gender,address,department,mobileno from regis";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=G:\12\App_Data\Database.mdf;Integrated Security=True");
        //con.Open();
        //string str1 = "update regis set status=1";
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=G:\12\App_Data\Database.mdf;Integrated Security=True");
        con.Open();
        string str3 = "insert into login values('"+TextBox17.Text+"','"+Label34.Text+"','"+Label49.Text+"','"+DropDownList13.Text+"','"+DropDownList14.Text+"','"+DropDownList15.Text+"','"+Label32.Text+"')";
