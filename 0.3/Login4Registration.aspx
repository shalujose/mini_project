...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1" style="font-weight: bold">
        ...
        <tr>
            <a href="Login4Registration.aspx">Login4Registration.aspx</a><td class="auto-style2">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
    </table>
    <table class="auto-style1" style="font-weight: bold">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox1" runat="server" Width="128px" TextMode="Password"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
