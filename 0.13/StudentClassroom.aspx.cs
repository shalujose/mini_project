...
public partial class StudentClassroom : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=G:\12\App_Data\Database.mdf;Integrated Security=True");
        con.Open();
        string str = "insert into Messenger values('"+Session["username"].ToString()+"','"+DropDownList11.Text+"','"+TextBox7.Text+"','"+TextBox8.Text+"','"+DateTime.Now.ToString("dd/mm/yyyy hh:mm tt")+"','"+DropDownList12.Text+"','"+DropDownList13.Text+"','"+DropDownList10.Text+"','"+Session["batch"].ToString()+"','"+Session["usertype"].ToString()+"','"+DropDownList9.Text+"')";
