...
public partial class StudentExam : System.Web.UI.Page
{
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string startex = "select subject,qno,question,mark from Exam_questions where examname='"+Label19.Text+"' and department='" + Session["department"].ToString() + "' and semester='" + Session["semester"].ToString() + "' and batch='" + Session["batch"].ToString() + "' ";
