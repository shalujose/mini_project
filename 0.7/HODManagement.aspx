            ...
            <td class="auto-style17">
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="View4" runat="server">
                        <table class="auto-style51">
                            <tr>
                                <td style="color: #000080" class="auto-style72">ExamTimetable</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList23" runat="server" Height="142px" Width="187px" OnSelectedIndexChanged="DropDownList23_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style72">&nbsp;</td>
                                <td>
                                    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" OnSelectedIndexChanged="GridView4_SelectedIndexChanged" Width="450px">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="max_mark" HeaderText="Maximum Mark" />
